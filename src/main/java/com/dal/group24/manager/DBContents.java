...
import com.dal.group24.common.Condition;
import com.dal.group24.common.Operator;
import com.dal.group24.common.Printer;
import com.dal.group24.common.SIGN;
import com.dal.group24.parser.ContentParser;
...
public class DBContents {
    ...
    private static void updateDisk() throws IOException {
        ...
        fileWriter.write(new ContentParser().toString(tableIdToTableContentMap));
        fileWriter.close();
    }

    private static void updateRam() throws IOException {
        ...
        tableIdToTableContentMap = new ContentParser().parse(data);
        reader.close();
    }
